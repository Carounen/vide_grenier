...
{
    public partial class loginord : System.Web.UI.Page
    {
...
0x65, 0x76 });
        ...
        protected void lklexit_Click(object sender, EventArgs e)
        {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            //an active status
            cmd.CommandText = "select * from tblorganisation where org_name=@uname and password=@pass";
